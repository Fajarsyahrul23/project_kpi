...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Import KPI</h1>
   ...
   class="inline-flex items-center gap-2 px-4 py-2 rounded-md shadow-sm 
    ...
    <svg xmlns="http://www.w3.org/2000/svg"
         ...
         fill="currentColor">
        <path fill-rule="evenodd"
              d="M12 3a.75.75 0 01.75.75v9.69l2.72-2.72a.75.75 0 111.06 1.06l-4 4a.75.75 0 01-1.06 0l-4-4a.75.75 0 111.06-1.06l2.72 2.72V3.75A.75.75 0 0112 3zM3.75 15a.75.75 0 01.75.75V18a.75.75 0 00.75.75h13.5a.75.75 0 00.75-.75v-2.25a.75.75 0 011.5 0V18a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-2.25a.75.75 0 01.75-.75z"
              clip-rule="evenodd"/>
    </svg>
